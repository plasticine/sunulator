defmodule Sunulator.SimulationsTest do
  ...
  describe "scenarios" do
    ...
    test "list_scenarios/0 returns all scenarios" do
      scenario =
        Fixtures.Simulations.Scenario.insert!()
        |> Map.put(:location, %NotLoaded{__field__: :location, __cardinality__: :one, __owner__: Scenario})
    ...
    test "update_scenario/2 with valid data updates the scenario" do
      scenario = Fixtures.Simulations.Scenario.insert!()
